...
trial_space = {
    ...
    "imitator_feature_extractor_obs_keys": tune.grid_search([["obs"], ["obs", "permutation"]]),
    "kl_weight": 1.0,
    "latent_dim": 64,
    "load_best": True,
...
tuner = tune.Tuner(trainable, param_space=trial_space, run_config=RunConfig(local_dir="logs/20230512_lunar_lander_bc_naive_and_oracle"))
tuner.fit()
